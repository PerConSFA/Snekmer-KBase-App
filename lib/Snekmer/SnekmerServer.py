...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'Snekmer'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from Snekmer.SnekmerImpl import Snekmer  # noqa @IgnorePep8
impl_Snekmer = Snekmer(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'Snekmer'
